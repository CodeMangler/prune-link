...
USER_AGENT_REQUEST_URL = 'http://www.useragentstring.com/?uas=%(UAS)&getJSON=all'
GEOLOCATION_REQUEST_URL = 'http://api.ipinfodb.com/v2/ip_query.php?key=0bde88d75043de5ab285b843b0a682cf8a50687e21e3a39d2e82cba582456509&ip=%(IP)&output=json&timezone=false'
